...
const result = getRandomMovie(listOfMovies);
console.log(result);

// so next step is how to display the random movie on the screen on the html
...
const firstMovie = listOfMovies[0];
console.log(firstMovie);

const secondMovie = listOfMovies[1];
console.log(secondMovie);

const thirdMovie = listOfMovies[2];
console.log(thirdMovie);

const fourthMovie = listOfMovies[3];
console.log(fourthMovie);

const fifthMovie = listOfMovies[4];
console.log(fifthMovie);

const sixthMovie = listOfMovies[5];
console.log(sixthMovie);

const seventhMovie = listOfMovies[6];
console.log(seventhMovie);

const eigthMovie = listOfMovies[7];
console.log(eigthMovie);

const ninthMovie = listOfMovies[8];
console.log(ninthMovie);

const tenthMovie = listOfMovies[9];
console.log(tenthMovie);

const eleventhMovie = listOfMovies[10];
console.log(eleventhMovie);

const twelfthMovie = listOfMovies[11];
console.log(twelfthMovie);
